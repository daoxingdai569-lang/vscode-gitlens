	...
	private async runLoop(
		...
		const onLoopChange = () => {
			...
			while (reportedSteps < steps.length) {
				...
				// A `manual` step is one automation escalated and the user resolved — nothing here was
				// AI-resolved, applied, or staged, and the recorded files carry the AI's *attempted*
				// strategy plus a stand-in confidence of 1. Reporting it would credit the AI for the
